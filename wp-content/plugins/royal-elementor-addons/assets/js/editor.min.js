( function( $ ) {//TODO: manage comments
    ...
    elementor.hooks.addAction( 'panel/open_editor/widget/wpr-form-builder', function( panel, model, view ) {
		...
		function updateDynamicOptions () {
			...
			view.model.setSetting('email_field', _.extend(emailField, { options })); // is it necessary ?
			view.model.setSetting('first_name_field', _.extend(firstNameField, { options })); // is it necessary ?
			view.model.setSetting('last_name_field', _.extend(lastNameField, { options })); // is it necessary ?
			view.model.setSetting('address_field', _.extend(addressField, { options })); // is it necessary ?
			view.model.setSetting('phone_field', _.extend(phoneField, { options })); // is it necessary ?
			view.model.setSetting('birthday_field', _.extend(birthdayField, { options })); // is it necessary ?
