...
if ( ! class_exists( 'WooCustomizer_Library_Styles' ) ) :
/**
 ...
 */
class WooCustomizer_Library_Styles {

	/**
	 * The one instance of WooCustomizer_Library_Styles.
	 *
	 * @since 1.0.0.
	 *
	...
	/**
	 * Instantiate or return the one WooCustomizer_Library_Styles instance.
	 *
	 * @since  1.0.0.
	 *
	 * @return WooCustomizer_Library_Styles
	 */
	...
	private function parse_declarations( $declarations, $tab = '' ) {
		 ...
		 * routines are implemented when the developer calls `WooCustomizer_Library_Styles()->add`. Because every property value has
